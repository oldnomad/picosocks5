 ...
 * MD5 implementation.
 *
 * This implementation is based on classic public domain code by Colin Plumb.
 *
 ...
 */
MD5_DECL void MD5Init(struct MD5Context *ctx)
{
 ...
 */
MD5_DECL void MD5Update(struct MD5Context *ctx, const unsigned char *buf, uint32_t len)
{
 ...
 * @param ctx MD5 context.
 */
MD5_DECL void MD5Final(unsigned char digest[], struct MD5Context *ctx)
{
